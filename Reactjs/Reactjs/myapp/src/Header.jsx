// each component has same function
...
const Header = ({ isOpen, toggle }) => {
  ...
  //     // If the state 'isSh' changes to true (i.e., onClick is triggered), start the timer
  ...
  const handleClick = () => {
    // Toggle the state 'isSh' to trigger the timer when clicked
    setShowDarkModeToggle(!showDarkModeToggle);
  };
 ...
 {showModal && <CreateModel   onClose={handleCloseModal} />} */}
      {auth ? (
        <div
          ...
          style={{ backgroundColor: "white", position: "fixed", top: "0" }}
        >
          {/*begin::Container*/}
                        ...
                        >
                          <div>
                            <div className="menu-item">
                              ...
                              <Link className="menu-link " to="/multipurpose">
                            ...
                            <div className="menu-item">
                              <Link to="/ecomercecontent" className="menu-link">
                                <span className="menu-bullet">
                                  <span className="bullet bullet-dot" />
                                </span>
                                <span
                            ...
                            <div className="menu-item">
                              <Link to="/projectcontent" className="menu-link">
                                <span className="menu-bullet">
                                  <span className="bullet bullet-dot" />
                                </span>
                                <span
                            ...
                            <div className="menu-item">
                              <Link to="/onlinecourse" className="menu-link">
                                <span className="menu-bullet">
                                  <span className="bullet bullet-dot" />
                                </span>
                                <span
                            ...
                            {isSh && (
                              <div className="menu-inner flex-column ">
                                <div className="menu-item">
                                  <Link
                                    to="/logisticcontent"
                                    className="menu-link"
                                ...
                                <div className="menu-item">
                                  <Link to="/school" className="menu-link">
                                    <span className="menu-bullet">
                                      <span className="bullet bullet-dot" />
                                    </span>
                                    <span
                  ...
                  {showDarkModeToggle && (
                    ...
                    >
                      <div data-kt-menu="true">
                        ...
                        >
                          ...
                          <div className="menu-sub menu-sub-dropdown w-175px py-4">
                            ...
                            <div className="menu-item px-3">
                              ...
                              >
                                <span className="symbol symbol-20px me-4">
                                  <img className="rounded-1" src={a} alt="" />
                                </span>
                                English
                              </a>
                            </div>
                            ...
                            <div className="menu-item px-3">
                              ...
                              >
                                <span className="symbol symbol-20px me-4">
                                  <img className="rounded-1" src={b} alt="" />
                                </span>
                                Spanish
                              </a>
                            </div>
                            ...
                            <div className="menu-item px-3">
                              ...
                              >
                                <span className="symbol symbol-20px me-4">
                                  <img className="rounded-1" src={c} alt="" />
                                </span>
                                German
                              </a>
                            </div>
                            ...
                            <div className="menu-item px-3">
                              ...
                              >
                                <span className="symbol symbol-20px me-4">
                                  <img className="rounded-1" src={d} alt="" />
                                </span>
                                Japanese
                              </a>
                            </div>
                            ...
                            <div className="menu-item px-3">
                              ...
                              >
                                <span className="symbol symbol-20px me-4">
                                  <img className="rounded-1" src={e} alt="" />
                                </span>
                                French
                              </a>
                            </div>
                        ...
                        {/*end::Menu item*/}
                        {/*begin::Menu item*/}
                        <div onClick={handleDelete} className="menu-item px-5">
