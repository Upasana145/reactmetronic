                                ...
                                <div className="card-body d-flex flex-column flex-center">
                                  ...
                                  <div className="mb-2">
                                    ...
                                    <div
                                      ...
                                      style={{
                                        backgroundImage:
                                          'url("assets/media/svg/illustrations/easy/4.svg")',
                                      }}
                                    />
                                    {/*end::Illustration*/}
                                  </div>
                                    ...
                                    <div className="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                      ...
                                      <div className="mb-4 px-9">
                                        ...
                                        <div className="d-flex align-items-center mb-2">
                                          ...
                                          {/*end::Value*/}
                                          {/*begin::Label*/}
                                          <span className="d-flex align-items-end text-gray-400 fs-6 fw-bold">
                                            Tons
                                          </span>
                                          {/*end::Label*/}
                                        </div>
                                      ...
                                      <div className="d-flex align-items-center flex-wrap">
                                        ...
                                        <div className="d-flex flex-column content-justify-center flex-grow-1">
                                          ...
                                          <div className="d-flex fs-6 fw-bold align-items-center">
                                            ...
                                            {/*end::Bullet*/}
                                            {/*begin::Label*/}
                                            <div className="fs-6 fw-bold text-gray-400 flex-shrink-0">
                                              Used Truck freight
                                            </div>
                                            {/*end::Label*/}
                                            {/*begin::Separator*/}
                                            <div className="separator separator-dashed min-w-10px flex-grow-1 mx-2" />
                                            {/*end::Separator*/}
                                            {/*begin::Stats*/}
                                            <div className="ms-auto fw-boldest text-gray-700 text-end">
                                              45%
                                            </div>
                                            {/*end::Stats*/}
                                          </div>
                                        ...
                                        <div className="d-flex align-items-sm-center mb-5">
                                          ...
                                          <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                            <div className="flex-grow-1 me-2">
                                              <a
                                                href="#"
                                                className="text-gray-400 fs-6 fw-bold"
                                              >
                                                Ship Freight
                                              </a>
                                              <span className="text-gray-800 fw-bolder d-block fs-4">
                                                #5635-342808
                                              </span>
                                            </div>
                                            <span className="badge badge-lg badge-light-success fw-bolder my-2">
                                              Delivered
                                            </span>
                                          </div>
                                          {/*end::Section*/}
                                        ...
                                        <div className="timeline">
                                          ...
                                          <div className="timeline-item align-items-center mb-7">
                                            ...
                                            <div className="timeline-content m-0">
                                              {/*begin::Title*/}
                                              <span className="fs-6 text-gray-400 fw-bold d-block">
                                                Messina Harbor
                                              </span>
                                              {/*end::Title*/}
                                              {/*begin::Title*/}
                                              <span className="fs-6 fw-bolder text-gray-800">
                                                Sicily, Italy
                                              </span>
                                              {/*end::Title*/}
                                            </div>
                                      ...
                                      <div className="m-0">
                                        ...
                                        <div className="d-flex align-items-sm-center mb-5">
                                          ...
                                          <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <span className="badge badge-lg badge-light-primary fw-bolder my-2">
                                              Shipping
                                            </span>
                                          </div>
                                          {/*end::Section*/}
                                      ...
                                      <div className="m-0">
                                        ...
                                        <div className="d-flex align-items-sm-center mb-5">
                                          ...
                                          <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <span className="badge badge-lg badge-light-danger fw-bolder my-2">
                                              Delayed
                                            </span>
                                          </div>
                                          {/*end::Section*/}
                                    ...
                                    <div className="card-body d-flex flex-column justify-content-between pb-5 px-0">
                                      ...
                                      <ul className="nav nav-pills nav-pills-custom mb-3 mx-9">
                                        ...
                                        <li className="nav-item mb-3 me-3 me-lg-6">
                                          {/*begin::Link*/}
                                          <a
                                            className="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 active"
                                            data-bs-toggle="pill"
                                          ...
                                          >
                                            ...
                                            <div className="nav-icon mb-3">
                                              <i className="fonticon-ship fs-1 p-0" />
                                            </div>
                                            {/*end::Icon*/}
                                            {/*begin::Title*/}
                                        ...
                                        <li className="nav-item mb-3 me-3 me-lg-6">
                                          {/*begin::Link*/}
                                          <a
                                            className="nav-link btn btn-outline btn-flex btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                            data-bs-toggle="pill"
                                        ...
                                        <li className="nav-item mb-3 me-3 me-lg-6">
                                          ...
                                          >
                                            {/*begin::Icon*/}
                                            <div className="nav-icon mb-3">
                                              <i className="fonticon-offline fs-1 p-0" />
                                            </div>
                                            {/*end::Icon*/}
                                            {/*begin::Title*/}
                                            <span className="nav-text text-gray-800 fw-bolder fs-6 lh-1">
                                        ...
                                        <li className="nav-item mb-3 me-3 me-lg-6">
                                          ...
                                          >
                                            {/*begin::Icon*/}
                                            <div className="nav-icon mb-3">
                                              <i className="fonticon-train fs-1 p-0" />
                                            </div>
                                            {/*end::Icon*/}
                                            {/*begin::Title*/}
                                            <span className="nav-text text-gray-800 fw-bolder fs-6 lh-1">
                                      ...
                                      <div className="tab-content ps-4 pe-6">
                                        ...
                                        >
                                          {/*begin::Chart*/}
                                          <div
                                            id="kt_charts_widget_10_chart_1"
                                            className="min-h-auto"
                                            style={{ height: 270 }}
                                          />
                                          {/*end::Chart*/}
                                        ...
                                        >
                                          {/*begin::Chart*/}
                                          <div
                                            id="kt_charts_widget_10_chart_2"
                                            className="min-h-auto"
                                            style={{ height: 270 }}
                                          />
                                          {/*end::Chart*/}
                                        ...
                                        >
                                          {/*begin::Chart*/}
                                          <div
                                            id="kt_charts_widget_10_chart_3"
                                            className="min-h-auto"
                                            style={{ height: 270 }}
                                          />
                                          {/*end::Chart*/}
                                        ...
                                        >
                                          {/*begin::Chart*/}
                                          <div
                                            id="kt_charts_widget_10_chart_4"
                                            className="min-h-auto"
                                            style={{ height: 270 }}
                                          />
                                          {/*end::Chart*/}
                                ...
                                <div className="card-body pt-4">
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-5">
                                      ...
                                      <div className="symbol symbol-40px me-4">
                                        <span className="symbol-label">
                                          <i className="fonticon-ship fs-1 p-0 text-gray-600" />
                                        </span>
                                      </div>
                                      {/*end::Symbol*/}
                                      {/*begin::Content*/}
                                    ...
                                    <div className="text-gray-400 fw-bolder fs-7 text-end">
                                      {/*begin::Number*/}
                                      <span className="text-gray-800 fw-bolder fs-6 d-block">
                                        2,345,500
                                      </span>
                                      {/*end::Number*/}Tons
                                    </div>
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-5">
                                      ...
                                      <div className="symbol symbol-40px me-4">
                                        <span className="symbol-label">
                                          <i className="fonticon-truck fs-1 p-0 text-gray-600" />
                                        </span>
                                      </div>
                                      {/*end::Symbol*/}
                                      {/*begin::Content*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-5">
                                      ...
                                      <div className="symbol symbol-40px me-4">
                                        <span className="symbol-label">
                                          <i className="fonticon-offline fs-1 p-0 text-gray-600" />
                                        </span>
                                      </div>
                                      {/*end::Symbol*/}
                                      {/*begin::Content*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-5">
                                      ...
                                      <div className="symbol symbol-40px me-4">
                                        <span className="symbol-label">
                                          <i className="fonticon-train fs-1 p-0 text-gray-600" />
                                        </span>
                                      </div>
                                      {/*end::Symbol*/}
                                      {/*begin::Content*/}
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-header pt-7">
                                  ...
                                  <div className="card-toolbar">
                                    ...
                                    {/*begin::Menu*/}
                                    <div
                                      className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-100px py-4"
                                      data-kt-menu="true"
                                    >
                                      {/*begin::Menu item*/}
