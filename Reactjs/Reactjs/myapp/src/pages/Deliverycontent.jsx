                        ...
                        >
                          ...
                          <div className="row gy-5 g-xl-10">
                            ...
                            <div className="col-xl-4 mb-xl-10">
                              ...
                              <div className="card bg-primary h-md-100">
                                {/*begin::Body*/}
                                <div className="card-body d-flex flex-column pt-13 pb-14">
                                  ...
                                  <div className="text-center">
                                    {/*begin::Link*/}
                                    <a
                                      className="btn btn-sm btn-white btn-color-gray-800 me-2"
                                ...
                                <div className="card-body pb-0 pt-4">
                                  ...
                                  <div className="tab-content">
                                    ...
                                    >
                                      ...
                                      <div className="mb-2">
                                        {/*begin::Statistics*/}
                                        <span className="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2">
                                          1,349
                                        </span>
                                        {/*end::Statistics*/}
                                        {/*begin::Description*/}
                            ...
                            <div className="col-xl-4 mb-xl-10">
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-header pt-7">
                                  ...
                                  <div className="card-toolbar">
                                    <a
                                      ...
                                      title="Delivery App is coming soon"
                                    >
                                      View All
                                    </a>
                                  </div>
                                ...
                                <div className="card-body pt-4 px-0">
                                  {/*begin::Nav*/}
                                  <ul className="nav nav-pills nav-pills-custom item position-relative mx-9 mb-9">
                                    {/*begin::Item*/}
                                  ...
                                  >
                                    ...
                                    >
                                        ...
                                        <div className="timeline ms-n1">
                                          ...
                                          <div className="timeline-item align-items-center mb-4">
                                            ...
                                            <div className="timeline-content m-0">
                                              {/*begin::Label*/}
                                              <span className="fs-8 fw-boldest text-success text-uppercase">
                                                Sender
                                              </span>
                                              {/*begin::Label*/}
                                              {/*begin::Title*/}
                                              <a
                                                href="#"
                                                className="fs-6 text-gray-800 fw-bolder d-block text-hover-primary"
                                              >
                                                Brooklyn Simmons
                                              </a>
                                              {/*end::Title*/}
                                          ...
                                          <div className="timeline-item align-items-center">
                                            ...
                                            <div className="timeline-content m-0">
                                              {/*begin::Label*/}
                                              <span className="fs-8 fw-boldest text-info text-uppercase">
                                                Receiver
                                              </span>
                                              {/*begin::Label*/}
                                              {/*begin::Title*/}
                                      ...
                                      {/*end::Item*/}
                                      {/*begin::Separator*/}
                                      <div className="separator separator-dashed mt-5 mb-4" />
                                      {/*end::Separator*/}
                                      {/*begin::Item*/}
                                      <div className="m-0">
                                        {/*begin::Timeline*/}
                            ...
                            <div className="col-xl-8 mb-5 mb-xl-10">
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-body d-flex flex-column justify-content-between pb-5 px-0">
                                  {/*begin::Nav*/}
                                  <ul className="nav nav-pills nav-pills-custom mb-3 mx-9">
                                    {/*begin::Item*/}
                                    ...
                                    <li className="nav-item mb-3 me-3 me-lg-6">
                                      ...
                                      <a
                                        ...
                                        data-bs-toggle="pill"
                                        id="kt_charts_widget_32_tab_2"
                                        href="#kt_charts_widget_32_tab_content_2"
                                      >
                                        {/*begin::Icon*/}
                                        <div className="nav-icon mb-3">
                                          <i className="fonticon-bicycle fs-1 p-0" />
                                        </div>
                                        {/*end::Icon*/}
                                        {/*begin::Title*/}
                                        <span className="nav-text text-gray-800 fw-bolder fs-6 lh-1">
                                    ...
                                    <li className="nav-item mb-3 me-3 me-lg-6">
                                      ...
                                      <a
                                        className="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                        data-bs-toggle="pill"
                                        id="kt_charts_widget_32_tab_3"
                                        href="#kt_charts_widget_32_tab_content_3"
                                      >
                                        {/*begin::Icon*/}
                                        <div className="nav-icon mb-3">
                                          <i className="fonticon-drone fs-1 p-0" />
                                        </div>
                                        {/*end::Icon*/}
                                        {/*begin::Title*/}
                                        <span className="nav-text text-gray-800 fw-bolder fs-6 lh-1">
                                  ...
                                  <div className="tab-content ps-4 pe-6">
                                    ...
                                    <div
                                      className="tab-pane fade active show"
                                      id="kt_charts_widget_32_tab_content_1"
                                    >
                                      {/*begin::Chart*/}
                                      <div
                                        id="kt_charts_widget_32_chart_1"
                                    ...
                                    <div
                                      className="tab-pane fade"
                                      id="kt_charts_widget_32_tab_content_2"
                                    >
                                      {/*begin::Chart*/}
                                      <div
                                        id="kt_charts_widget_32_chart_2"
                                        className="min-h-auto"
                                        style={{ height: 375 }}
                                      />
                                      {/*end::Chart*/}
                                    ...
                                    <div
                                      className="tab-pane fade"
                                      id="kt_charts_widget_32_tab_content_3"
                                    >
                                      {/*begin::Chart*/}
                                      <div
                                        id="kt_charts_widget_32_chart_3"
                                        className="min-h-auto"
                                        style={{ height: 375 }}
                                      />
                                      {/*end::Chart*/}
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-body pt-0">
                                  ...
                                  <div className="d-flex flex-stack my-5">
                                    <span className="text-gray-400 fs-7 fw-bolder">
                                      ITEM
                                    </span>
                                    <span className="text-gray-400 fw-bolder fs-7">
                                      ITEM PRICE
                                    </span>
                                  </div>
                                  {/*end::Content*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-3">
                                      {/*begin::Icon*/}
                                      <img
                                        src="assets/media/stock/ecommerce/14.gif"
                                        className="me-4 w-50px"
                                        alt=""
                                      />
                                      {/*end::Icon*/}
                                      {/*begin::Section*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-3">
                                      {/*begin::Icon*/}
                                      <img
                                        src="assets/media/stock/ecommerce/13.gif"
                                        className="me-4 w-50px"
                                        alt=""
                                      />
                                      {/*end::Icon*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-3">
                                      {/*begin::Icon*/}
                                      <img
                                        src="assets/media/stock/ecommerce/41.gif"
                                        className="me-4 w-50px"
                                        alt=""
                                      />
                                      {/*end::Icon*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-3">
                                      {/*begin::Icon*/}
                                      <img
                                        src="assets/media/stock/ecommerce/53.gif"
                                        className="me-4 w-50px"
                                        alt=""
                                      />
                                      {/*end::Icon*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-3">
                                      {/*begin::Icon*/}
                                      <img
                                        src="assets/media/stock/ecommerce/71.gif"
                                        className="me-4 w-50px"
                                        alt=""
                                      />
                                      {/*end::Icon*/}
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-center me-3">
                                      {/*begin::Icon*/}
                                      <img
                                        src="assets/media/stock/ecommerce/194.gif"
                                        className="me-4 w-50px"
                                        alt=""
                                      />
                                      {/*end::Icon*/}
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <div className="rating">
                                                  <div className="rating-label me-1 checked">
                                                ...
                                                <span className="text-muted fw-bold d-block fs-7 mt-1">
                                                  Rating
                                                </span>
                                              </td>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <div className="rating">
                                                  ...
                                                  <div className="rating-label me-1">
                                                    <i className="bi bi-star-fill fs-6s" />
                                                  </div>
                                                </div>
                                                <span className="text-muted fw-bold d-block fs-7 mt-1">
