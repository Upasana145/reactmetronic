                ...
                <div>
                  <>
                    ...
                    >
                      {/*begin::Toolbar*/}
                      <div
                        className="toolbar bg-transparent pt-6 mb-5"
                        id="kt_toolbar"
                      >
                        {/*begin::Container*/}
                        <div
                          id="kt_toolbar_container"
                          className="container-xxl d-flex flex-stack"
                        >
                          {/*begin::Page title*/}
                          <div
                          ...
                          <div className="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a
                              ...
                              className="btn btn-sm btn-white btn-active-white btn-active-color-primary"
                        ...
                        >
                          ...
                          <div className="row g-5 g-xl-10 mb-5 mb-xl-10">
                            ...
                            <div className="col-xxl-6">
                              ...
                              <div className="card card-flush border-0 h-xl-100">
                                {/*begin::Body*/}
                                <div className="card-body py-9">
                                  ...
                                  <div className="row gx-9 h-100">
                                    ...
                                    <div className="col-sm-6 mb-10 mb-sm-0">
                                      {/*begin::Overlay*/}
                                      <a
                                        className="d-block overlay h-100"
                                        data-fslightbox="lightbox-hot-sales"
                                        href="assets/media/stock/600x600/img-42.jpg"
                                      >
                                        {/*begin::Image*/}
                                        <div
                                          className="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-200px h-100"
                                          style={{
                                            backgroundImage:
                                              'url("assets/media/stock/600x600/img-42.jpg")',
                                          }}
                                        />
                                        {/*end::Image*/}
                                        {/*begin::Action*/}
                                    ...
                                    <div className="col-sm-6">
                                      ...
                                      <div className="d-flex flex-column h-100">
                                        ...
                                        <div className="mb-7">
                                          {/*begin::Title*/}
                                          <div className="mb-6">
                                            <span className="text-gray-400 fs-7 fw-bolder me-2 d-block lh-1 pb-1">
                                              NFT ID: 34356776
                                            </span>
                                            <a
                                              href="../../demo1/dist/apps/projects/users.html"
                                              className="text-gray-800 text-hover-primary fs-1 fw-bolder"
                                            >
                                              California Art
                                            </a>
                                          </div>
                                          ...
                                          <div className="d-flex align-items-center flex-wrap d-grid gap-2">
                                            ...
                                            <div className="d-flex align-items-center me-5 me-xl-13">
                                              ...
                                              {/*begin::Info*/}
                                              <div className="m-0">
                                                <span className="fw-bold text-gray-400 d-block fs-8">
                                                  Creator
                                                </span>
                                                <a
                                                  href="../../demo1/dist/apps/projects/users.html"
                                                  className="fw-bolder text-gray-800 text-hover-primary fs-7"
                                                >
                                                  Robert Fox
                                                </a>
                                              </div>
                                        ...
                                        {/*end::Header*/}
                                        {/*begin::Body*/}
                                        <div className="d-flex flex-column border border-1 border-gray-300 text-center pt-5 pb-7 mb-8 card-rounded">
                                          <span className="fw-bold text-gray-600 fs-7 pb-1">
                                            Last Bid
                                          </span>
                                          <span className="fw-bolder text-gray-800 fs-2hx lh-1 pb-1">
                                            2.48 ETH
                                          </span>
                                          <span className="fw-bolder text-gray-600 fs-4 pb-5">
                                            $6,047.84
                                          </span>
                                          <span className="fw-bold text-gray-600 fs-7 pb-1">
                                            Ending in
                                          </span>
                                          <span className="fw-bolder text-gray-800 fs-3">
                                            06h 52m 47s
                                          </span>
                                        </div>
                                        {/*end::Body*/}
                            ...
                            <div className="col-sm-6 col-xxl-3">
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-body text-center pb-5">
                                  ...
                                  >
                                    ...
                                    <div
                                      ...
                                      style={{
                                        height: 266,
                                        backgroundImage:
                                          'url("assets/media/stock/600x600/img-39.jpg',
                                      }}
                                    />
                                    {/*end::Image*/}
                                    {/*begin::Action*/}
                                  ...
                                  <div className="d-flex align-items-end flex-stack mb-1">
                                    ...
                                    <div className="text-start">
                                      <span className="fw-bolder text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">
                                        Wavy Curved Art
                                      </span>
                                      <span className="text-gray-400 mt-1 fw-bolder fs-6">
                                        Last Bid: 1.07 ETH
                                      </span>
                                    </div>
                                    {/*end::Title*/}
                                    {/*begin::Total*/}
                                    <span className="text-gray-600 text-end fw-bolder fs-6">
                                      $2,630
                                    </span>
                                    {/*end::Total*/}
                                  </div>
                                ...
                                <div className="card-footer d-flex flex-stack pt-0">
                                  {/*begin::Link*/}
                                  <a
                                    className="btn btn-sm btn-primary flex-shrink-0 me-2"
                                    data-bs-target="#kt_modal_bidding"
                                    data-bs-toggle="modal"
                                  >
                                    Place a Bid
                                  ...
                                  >
                                    ...
                                    <div
                                      ...
                                      style={{
                                        height: 266,
                                        backgroundImage:
                                          'url("assets/media/stock/600x600/img-47.jpg',
                                      }}
                                    />
                                    {/*end::Image*/}
                                    {/*begin::Action*/}
                                ...
                                <div className="card-header pt-5 mb-6">
                                  ...
                                  <h3 className="card-title align-items-start flex-column">
                                    ...
                                    <div className="d-flex align-items-center mb-2">
                                      {/*begin::Currency*/}
                                      <span className="fs-3 fw-bold text-gray-400 align-self-start me-1">
                                        $
                                      </span>
                                      {/*end::Currency*/}
                                      {/*begin::Value*/}
                                ...
                                <div className="card-body py-0 px-0">
                                  ...
                                  <div className="tab-content mt-n6">
                                    ...
                                    >
                                      {/*begin::Chart*/}
                                      <div
                                        id="kt_charts_widget_33_chart_1"
                                          ...
                                          <tbody>
                                            <tr>
                                              <td>
                                                <a
                                                  href="#"
                                                  className="text-gray-600 fw-bolder fs-6"
                                                >
                                                  2:30 PM
                                                </a>
                                              </td>
                                              <td className="pe-0 text-end">
                                                <span className="text-gray-800 fw-bolder fs-6 me-1">
                                                  $2,756.26
                                                </span>
                                              </td>
                                              <td className="pe-0 text-end">
                                        ...
                                        <table className="table align-middle gs-0 gy-4">
                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              <td className="pe-0 text-end">
                                                <span className="fw-bolder fs-6 text-warning">
                                                  +134.57
                                                </span>
                                              </td>
                                            </tr>
                                        ...
                                        <table className="table align-middle gs-0 gy-4">
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td className="pe-0 text-end">
                                                <span className="fw-bolder fs-6 text-info">
                                                  -134.03
                                                </span>
                                              </td>
                                            </tr>
                                ...
                                <div className="card-body">
                                  ...
                                  <div className="table-responsive">
                                    ...
                                    <table className="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                      {/*begin::Table head*/}
                                      <thead>
                                        <tr className="fs-7 fw-bolder text-gray-400 border-bottom-0">
                                          ...
                                          <th className="p-0 pb-3 min-w-125px text-end">
                                            RECENT OFFER
                                          </th>
                                          <th className="p-0 pb-3 min-w-100px text-end">
                                            TIME LEFT
                                          </th>
                                          <th className="p-0 pb-3 w-80px text-end">
                                            VIEW
                                          </th>
                                        </tr>
                                      </thead>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td className="text-end pe-0">
                                            <span className="text-gray-600 fw-bolder fs-6">
                                              0.054 ETH
                                            </span>
                                          </td>
                                          <td className="text-end pe-0">
                                        ...
                                        <tr>
                                          <td>
                                            <div className="d-flex align-items-center">
                                              <div className="symbol symbol-50px me-3">
                                                <img
                                                  src="assets/media/stock/600x600/img-43.jpg"
                                                  className=""
                                                  alt=""
                                                />
                                              </div>
                                        ...
                                        <tr>
                                          <td>
                                            <div className="d-flex align-items-center">
                                              <div className="symbol symbol-50px me-3">
                                                <img
                                                  src="assets/media/stock/600x600/img-46.jpg"
                                                  className=""
                                                  alt=""
                                                />
                                              </div>
                                        ...
                                        <tr>
                                          <td>
                                            <div className="d-flex align-items-center">
                                              <div className="symbol symbol-50px me-3">
                                                <img
                                                  src="assets/media/stock/600x600/img-54.jpg"
                                                  className=""
                                                  alt=""
                                                />
                                              </div>
                                        ...
                                        <tr>
                                          <td>
                                            <div className="d-flex align-items-center">
                                              <div className="symbol symbol-50px me-3">
                                                <img
                                                  src="assets/media/stock/600x600/img-45.jpg"
                                                  className=""
                                                  alt=""
                                                />
                                              </div>
                                ...
                                <div className="card-body pt-2">
                                  ...
                                  <div className="">
                                    ...
                                    <div className="d-flex flex-stack">
                                      ...
                                      <div className="d-flex align-items-center">
                                        {/*begin::Number*/}
                                        <span className="text-gray-800 fw-bolder fs-4 me-3">
                                          579
                                        </span>
                                        {/*end::Number*/}
                                        {/*begin::Info*/}
                                    ...
                                    <div className="d-flex flex-stack">
                                      ...
                                      <div className="d-flex align-items-center me-5">
                                        {/*begin::Flag*/}
                                        <img
                                          src="assets/media/svg/brand-logos/telegram-2.svg"
                                          className="me-4 w-30px"
                                          style={{ borderRadius: 4 }}
                                          alt=""
                                        />
                                    ...
                                    <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td className="text-end">
                                            <span className="text-gray-800 fw-bolder d-block mb-1 fs-6">
                                              1,240
                                            </span>
                                            <span className="fw-bold text-gray-400 d-block">
                                              Deliveries
                                            </span>
                                          </td>
                                          <td className="text-end">
                                            <a
                                              href="#"
                                              className="text-gray-800 fw-bolder text-hover-primary d-block mb-1 fs-6"
                                            >
                                              $5,400
                                            </a>
                                            <span className="text-gray-400 fw-bold d-block fs-7">
                                          ...
                                          <td className="float-end text-end border-0">
                                            <div className="rating">
                                              <div className="rating-label checked">
                                                <i className="bi bi-star-fill fs-6s" />
                                              </div>
                                              <div className="rating-label checked">
                                                <i className="bi bi-star-fill fs-6s" />
                                              </div>
                                            ...
                                            <span className="text-gray-400 fw-bold d-block fs-7 mt-1">
                                              Rating
                                            </span>
                                          </td>
                                          <td className="text-end">
                                            <a
                                              href="#"
                                              className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-25px h-25px"
                                            >
                                              {/*begin::Svg Icon | path: icons/duotune/arrows/arr001.svg*/}
                                              <span className="svg-icon svg-icon-5 svg-icon-gray-700">
                                                <svg
                                  ...
                                  <div className="card-toolbar">
                                    ...
                                    <div className="d-flex flex-stack flex-wrap gap-4">
                                      ...
                                      <div className="d-flex align-items-center fw-bolder">
                                        ...
                                        {/*begin::Select*/}
                                        <select
                                          className="form-select form-select-transparent text-graY-800 fs-base lh-1 fw-bolder py-0 ps-3 w-auto"
                                    ...
                                    <tbody className="fw-bolder text-gray-600">
                                      ...
                                      >
                                        ...
                                        <td className="text-end">
                                          ...
                                          <div
                                            className="text-muted fs-7 fw-bolder"
                                        ...
                                        <td className="text-end">
                                          <div className="text-gray-800 fs-7 me-3">
                                            On hand
                                          </div>
                                          <div
                                            className="text-muted fs-7 fw-bolder"
                                      ...
                                      <tr>
                                        ...
                                        <td className="text-end">
                                          <span className="text-gray-800 fw-boldest">
                                            $86.70
                                          </span>
                                        </td>
                                        <td className="text-end">
