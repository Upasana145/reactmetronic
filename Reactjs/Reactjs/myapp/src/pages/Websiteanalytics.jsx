                        ...
                        >
                          ...
                          <div className="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <div
                              ...
                              className="btn btn-sm btn-white btn-active-white btn-active-color-primary d-flex align-items-center px-4"
                            >
                              {/*begin::Display range*/}
                                    ...
                                    <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                      ...
                                      <thead>
                                        <tr className="fs-7 fw-bolder border-0 text-gray-400">
                                          ...
                                          <th
                                            className="min-w-150px text-end pe-0"
                                            colSpan={2}
                                          >
                                            SESSIONS
                                          </th>
                                          <th
                                            className="text-end min-w-150px"
                                            colSpan={2}
                                          >
                                            CONVERSION RATE
                                          </th>
                                        ...
                                        <tr>
                                          ...
                                          <td className="pe-0" colSpan={2}>
                                            <div className="d-flex justify-content-end">
                                              ...
                                              <span className="text-danger min-w-50px d-block text-end fw-bolder fs-6">
                                                -935
                                              </span>
                                            </div>
                                          </td>
                                          <td className="" colSpan={2}>
                                            <div className="d-flex justify-content-end">
                                              <span className="text-dark fw-bolder fs-6 me-3">
                                                23.63%
                                              </span>
                                              <span className="text-danger min-w-60px d-block text-end fw-bolder fs-6">
                                                -9.35%
                                              </span>
                                            </div>
                                          </td>
                                        ...
                                        <tr>
                                          ...
                                          <td className="pe-0" colSpan={2}>
                                            <div className="d-flex justify-content-end">
                                              ...
                                              <span className="text-success min-w-50px d-block text-end fw-bolder fs-6">
                                                +24
                                              </span>
                                            </div>
                                          </td>
                                          <td className="" colSpan={2}>
                                            <div className="d-flex justify-content-end">
                                              ...
                                              <span className="text-success min-w-60px d-block text-end fw-bolder fs-6">
                                                +28.73%
                                              </span>
                                            </div>
                                          </td>
                                    ...
                                    <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                      ...
                                      <thead>
                                        <tr className="fs-7 fw-bolder border-0 text-gray-400">
                                          ...
                                          <th
                                            className="min-w-100px text-end pe-0"
                                            colSpan={2}
                                          >
                                            CLICKS
                                          </th>
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-body pt-5">
                                  ...
                                  <div
                                    ...
                                    className="min-h-auto ps-4 pe-6 mb-3 h-300px"
                                  />
                                  {/*end::Chart container*/}
                                </div>
                                {/*end::Body*/}
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>
                                            <a
                                              href="#"
                                              className="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6"
                                            >
                                              Buy phone online
                                            </a>
                                          </td>
                                          <td className="d-flex align-items-center border-0">
                                            <span className="fw-bolder text-gray-800 fs-6 me-3">
                                              263
                                            </span>
                                        ...
                                        <tr>
                                          <td>
                                            <a
                                              ...
                                              className="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6"
                                            >
                                              Best noise cancelation headsets
                                            </a>
                                          </td>
                                          <td className="d-flex align-items-center border-0">
                                            <span className="fw-bolder text-gray-800 fs-6 me-3">
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-body d-flex align-items-end p-0">
                                  ...
                                  <div
                                    ...
                                    className="h-300px w-100 min-h-auto ps-7 pe-0 mb-5"
                                  />
                                  {/*end::Chart*/}
                                </div>
                                {/*end::Body*/}
                              ...
                              <div className="card card-flush h-xl-100">
                                ...
                                <div className="card-body d-flex justify-content-between flex-column">
                                  ...
                                  <div className="d-flex flex-wrap d-grid gap-5 mb-10">
                                    {/*begin::Item*/}
                                    <div className="border-end-dashed border-1 border-gray-300 pe-xxl-7 me-xxl-5">
                                      {/*begin::Statistics*/}
