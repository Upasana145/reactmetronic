...
<div>
      <>
  {/*begin::Wrapper*/}
  <div style={{position:'relative', top:'55px'}} className="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
    {/*begin::Content*/}
    <div
                ...
                <div className="card-body d-flex flex-column flex-center">
                  ...
                  <div className="mb-2">
                    ...
                    <h1 className="fw-bold text-gray-800 text-center lh-lg">
                      ...
                      <br />
                      new
                      <span className="fw-boldest">Invoice Manager ?</span>
                    </h1>
                    {/*end::Title*/}
                    {/*begin::Illustration*/}
                    <div
                    ...
                    <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 my-0">
                      ...
                      <thead>
                        <tr className="fs-7 fw-bolder text-gray-500 border-bottom-0">
                          ...
                          <th className="text-end min-w-140px p-0 pb-1">
                            TOTAL PRICE
                          </th>
                        </tr>
                      </thead>
            ...
            <div className="col-xxl-8 mb-5 mb-xl-10">
              ...
              <div className="card card-flush h-md-100">
                ...
                <div className="card-body pt-5">
                  ...
                  <div
                    id="kt_charts_widget_13_chart"
                    className="w-100 h-325px"
                  />
                  {/*end::Chart container*/}
                </div>
                {/*end::Body*/}
                ...
                <div className="card-body d-flex align-items-end">
                  ...
                  <div className="w-100">
                    ...
                    <div className="text-center pt-8 d-1">
                      <a
                        href="../../demo1/dist/apps/ecommerce/sales/details.html"
                        className="text-primary opacity-75-hover fs-6 fw-bolder"
                      >
