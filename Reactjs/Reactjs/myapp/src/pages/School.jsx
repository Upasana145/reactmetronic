        ...
        <div className="card card-flush mb-xxl-10">
          ...
          <div className="card-body">
            ...
            <div className="tab-content">
                  ...
                  <table className="table align-middle gs-0 gy-4 my-0">
                    ...
                    <thead>
                      <tr className="fs-7 fw-bolder text-gray-500">
                        <th className="p-0 min-w-150px d-block pt-3">
                          EMAIL TITLE
                        </th>
                        <th className="text-end min-w-140px pt-3">
                          STATUS
                        </th>
                        <th className="pe-0 text-end min-w-120px pt-3">
                          CONVERSION
                        </th>
                      </tr>
                    </thead>
              ...
              {/*end::Tap pane*/}
              {/*begin::Tap pane*/}
              <div className="tab-pane fade" id="kt_stats_widget_1_tab_2">
                {/*begin::Table container*/}
                <div className="table-responsive">
                  {/*begin::Table*/}
                  <table className="table align-middle gs-0 gy-4 my-0">
              ...
              {/*end::Tap pane*/}
              {/*begin::Tap pane*/}
              <div className="tab-pane fade" id="kt_stats_widget_1_tab_3">
                {/*begin::Table container*/}
                <div className="table-responsive">
                  {/*begin::Table*/}
                  <table className="table align-middle gs-0 gy-4 my-0">
              ...
              {/*end::Tap pane*/}
              {/*begin::Tap pane*/}
              <div className="tab-pane fade" id="kt_stats_widget_1_tab_4">
                {/*begin::Table container*/}
                <div className="table-responsive">
                  {/*begin::Table*/}
                  <table className="table align-middle gs-0 gy-4 my-0">
              ...
              >
                ...
                <div className="mb-5">
                  ...
                  <div className="d-flex align-items-center mb-2">
                    <span className="fs-1 fw-bold text-gray-400 me-1 mt-n1">
                      $
                    </span>
                    <span className="fs-3x fw-bolder text-gray-800 me-2 lh-1 ls-n2">
                      18,89
                    </span>
                    ...
                    <div className="mb-10">
                      ...
                      <div>
                        <select
                          ...
                          data-dropdown-parent="#kt_menu_6244460699851"
