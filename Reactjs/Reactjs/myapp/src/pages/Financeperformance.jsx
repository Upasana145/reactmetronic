                        ...
                        <div className="col-xl-6 mb-xl-10">
                          ...
                          <div className="card h-md-100">
                            ...
                            <div className="card-header align-items-center border-0">
                              {/*begin::Title*/}
                              <h3 className="fw-bolder text-gray-900 m-0">
                                Recent Orders
                              </h3>
                              {/*end::Title*/}
                              {/*begin::Menu*/}
                              ...
                              <ul className="nav nav-pills nav-pills-custom mb-3">
                                ...
                                <li className="nav-item mb-3 me-3 me-lg-6">
                                  ...
                                  >
                                    ...
                                    {/*end::Icon*/}
                                    {/*begin::Subtitle*/}
                                    <span className="nav-text text-gray-600 fw-bolder fs-6 lh-1">
                                      Watch
                                    </span>
                                    {/*end::Subtitle*/}
                                    {/*begin::Bullet*/}
                                    ...
                                    <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                      ...
                                      <thead>
                                        <tr className="fs-7 fw-bolder text-gray-500 border-bottom-0">
                                          ...
                                          <th className="text-end min-w-140px">
                                            QTY
                                          </th>
                                          <th className="pe-0 text-end min-w-120px">
                                            PRICE
                                          </th>
                                          <th className="pe-0 text-end min-w-120px">
                                            TOTAL PRICE
                                    ...
                                    <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/197.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/178.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/22.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                    ...
                                    <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/1.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/24.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                    ...
                                    <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/63.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/59.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                    ...
                                    <table className="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/10.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
                                        ...
                                        <tr>
                                          <td>
                                            <img
                                              src="assets/media/stock/ecommerce/96.gif"
                                              className="w-50px ms-n1"
                                              alt=""
                                            />
                                          </td>
