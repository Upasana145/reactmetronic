                        ...
                        >
                          ...
                          <div className="row g-5 g-xl-10 mb-xl-10">
                            ...
                            <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                              ...
                              <div
                                className="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center h-md-50 mb-5 mb-xl-10"
                                style={{
                                  backgroundColor: "#080655",
                                  backgroundImage:
                                    'url("assets/media/svg/shapes/wave-bg-dark.svg")',
                                }}
                              >
                                {/*begin::Header*/}
                                <div className="card-header pt-5">
                                  ...
                                  <div className="card-title d-flex flex-column">
                                    {/*begin::Amount*/}
                                    <span className="fs-2hx fw-bolder text-white me-2 lh-1 ls-n2">
                                      69
                                    </span>
                                    {/*end::Amount*/}
                                    {/*begin::Subtitle*/}
                                    <span className="text-white opacity-50 pt-1 fw-bold fs-6">
                                      Active Projects
                                    </span>
                                    {/*end::Subtitle*/}
                                  </div>
                                ...
                                <div className="card-body d-flex align-items-end pt-0">
                                  ...
                                  <div className="d-flex align-items-center flex-column mt-3 w-100">
                                    <div className="d-flex justify-content-between fw-bolder fs-6 text-white opacity-50 w-100 mt-auto mb-2">
                                ...
                                <div className="card-body pt-5">
                                  ...
                                  <div className="d-flex flex-stack">
                                    ...
                                    <div className="d-flex align-items-senter">
                                      ...
                                      {/*end::Number*/}
                                      <span className="text-gray-400 fw-bolder fs-6">
                                        /10
                                      </span>
                                    </div>
                                    {/*end::Statistics*/}
                                ...
                                <div className="card-body pt-7 px-0">
                                  ...
                                  <ul className="nav nav-stretch nav-pills nav-pills-custom nav-pills-active-custom d-flex justify-content-between mb-8 px-5">
                                    ...
                                    <li className="nav-item p-0 ms-0">
                                      ...
                                      >
                                        <span className="fs-7 fw-bold">Fr</span>
                                    ...
                                    <li className="nav-item p-0 ms-0">
                                      ...
                                      >
                                        <span className="fs-7 fw-bold">Sa</span>
                                        <span className="fs-6 fw-bolder">
                                          21
                                        </span>
                                      </a>
                                    ...
                                    <li className="nav-item p-0 ms-0">
                                      ...
                                      >
                                        <span className="fs-7 fw-bold">Su</span>
                                        <span className="fs-6 fw-bolder">
                                          22
                                        </span>
                                      </a>
                                    ...
                                    <li className="nav-item p-0 ms-0">
                                      ...
                                      >
                                        <span className="fs-7 fw-bold">Tu</span>
                                        <span className="fs-6 fw-bolder">
                                          23
                                        </span>
                                      </a>
                                    ...
                                    <li className="nav-item p-0 ms-0">
                                      ...
                                      >
                                        <span className="fs-7 fw-bold">We</span>
                                        <span className="fs-6 fw-bolder">
                                          25
                                        </span>
                                      </a>
                                    ...
                                    <li className="nav-item p-0 ms-0">
                                      ...
                                      >
                                        <span className="fs-7 fw-bold">Th</span>
                                        <span className="fs-6 fw-bolder">
                                          26
                                        </span>
                                      </a>
                                    ...
                                    <li className="nav-item p-0 ms-0">
                                      ...
                                      >
                                        <span className="fs-7 fw-bold">Mo</span>
                                        <span className="fs-6 fw-bolder">
                                          30
                                        </span>
                                      </a>
                                ...
                                <div className="card-body p-0">
                                  ...
                                  <ul className="nav nav-pills d-flex flex-nowrap hover-scroll-x py-2 ms-4">
                                    ...
                                    <li className="nav-item me-1">
                                      ...
                                      >
                                        <span className="text-gray-400 fs-7 fw-bold">
                                          Fr
                                        </span>
                                  ...
                                  <div className="row gx-9 h-100">
                                    ...
                                    <div className="col-sm-6">
                                      ...
                                      <div className="d-flex flex-column h-100">
                                        ...
                                        <div className="mb-7">
                                          ...
                                          <div className="d-flex flex-stack mb-6">
                                            ...
                                            <div className="flex-shrink-0 me-5">
                                              ...
                                              <span className="text-gray-800 fs-1 fw-bolder">
                                                9 Degree
                                              </span>
                                            </div>
                                            {/*end::Title*/}
                                        ...
                                        <div className="mb-6">
                                          {/*begin::Text*/}
                                          <span className="fw-bold text-gray-600 fs-6 mb-8 d-block">
                                            Flat cartoony illustrations with
                                            vivid unblended colors and
                                            asymmetrical beautiful purple hair
                                            lady
                                          </span>
                                          {/*end::Text*/}
                                          {/*begin::Stats*/}
                                  ...
                                  <div className="row align-items-center h-100">
                                    ...
                                    <div className="col-7 ps-xl-13">
                                      ...
                                      <div className="text-white mb-6 pt-6">
                                        <span className="fs-4 fw-bold me-2 d-block lh-1 pb-2 opacity-75">
                                          Get best offer
                                        </span>
                                      ...
                                      {/*end::Title*/}
                                      {/*begin::Text*/}
                                      <span className="fw-bold text-white fs-6 mb-8 d-block opacity-75">
                                        Flat cartoony and illustrations with
                                      ...
                                      <div className="d-flex align-items-center flex-wrap d-grid gap-2 mb-10 mb-xl-20">
                                        ...
                                        <div className="d-flex align-items-center me-5 me-xl-13">
                                          ...
                                          <div className="text-white">
                                            <span className="fw-bold d-block fs-8 opacity-75">
                                              Projects
                                            </span>
                                        ...
                                        <div className="d-flex align-items-center">
                                          ...
                                          {/*begin::Info*/}
                                          <div className="text-white">
                                            <span className="fw-bold opacity-75 d-block fs-8">
                                              Tasks
                                            </span>
                                            <span className="fw-bolder fs-7">
                                              Unlimited
                                      ...
                                      <div className="d-flex flex-column flex-sm-row d-grid gap-2">
                                        <a
                                          href="#"
                                          className="btn btn-success flex-shrink-0 me-2"
                                          data-bs-toggle="modal"
                            ...
                            <div className="col-xl-8">
                              ...
                              <div className="card h-md-100">
                                ...
                                <div className="card-header position-relative py-0 border-bottom-1">
                                  {/*begin::Card title*/}
                                  <h3 className="card-title text-gray-800 fw-bolder">
                                    Active Tasks
                                  </h3>
                                  {/*end::Card title*/}
                                  {/*begin::Tabs*/}
