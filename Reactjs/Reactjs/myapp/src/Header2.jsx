//each dropdown component has different different handle function 
...
import m from './assets/media/avatars/300-6.jpg'
import n from './assets/media/avatars/300-2.jpg'
import o from './assets/media/avatars/300-9.jpg'
import p from './assets/media/avatars/300-14.jpg'
import q from './assets/media/avatars/300-11.jpg'
import r from './assets/media/svg/brand-logos/volicity-9.svg'
import s from './assets/media/svg/brand-logos/tvit.svg'
import t from  './assets/media/svg/misc/infography.svg'
import u from  './assets/media/svg/brand-logos/leaf.svg'
import v from './assets/media/svg/brand-logos/tower.svg'
import w from './assets/media/illustrations/sketchy-1/1.png'
import x from './assets/media/avatars/300-1.jpg'
import y from './assets/media/avatars/300-1.jpg'
import z from './assets/media/flags/united-states.svg'
import a from './assets/media/flags/united-states.svg'
import b from './assets/media/flags/spain.svg'
import c from './assets/media/flags/germany.svg'
import d from './assets/media/flags/japan.svg'
import e from './assets/media/flags/france.svg'
...
{/* <link rel="shortcut icon" href="assets/media/logos/favicon.ico" />
  ...
  // ye isSh hm banaye hai show 10 more and show less ke liye
...
// 2nd  %%%%%%%%%%%%%%%%%%%%%%%%555 for show more-less
// ye hm dashboard ke liye banaye hai
...
const[expandcrafted, setExpandCrafted] = useState(false)


//  first %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
const handleExpandCrafted= () =>
{

setExpandCrafted(!expandcrafted)
}



const[expandapp, setExpandapp] = useState(false)
...
setExpandapp(!expandapp)
}



const[expandlayouts, setExpandLayouts] = useState(false)


//  first %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
const handleExpandLayouts= () =>
{

setExpandLayouts(!expandlayouts)
}
...
const[expandmegamap, setExpandMegamap] = useState(false)


//  first %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
const handleExpandMegamap= () =>
{

setExpandMegamap(!expandmegamap)
}
...
const handleExpanduser= () =>
{
  ...
  return (
    <div>
{/* 
      <button style={{backgroudColor:"green"}} onClick={handleButtonClick}>Open Modal</button>
      {/* <button style={{backgroudColor:"green"}} onClick={handleCloseModal}>Open Modal</button> */}
      {/* {showModal && <h1 style={{backgroud:"green"}} onClose={handleCloseModal}>dedhhhhhhhhhhhhhhhh
              ...
              <div className="d-flex align-items-stretch" id="kt_header_nav">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div style={{position:'relative',top:'0px'}} onClick={fatShow}>
                      ...
                      
  {
   ...
   <div style={{backgroundColor: 'White' , position:'fixed', top: '56px'  ,left: '265px'}}>
     ...
     <div className="menu-item">
               ...
               {/* %%%% active   className="menu-link active" */}
                ...
                <div className="menu-item">
                  ...
                  >
                    ...
                    <span style={{ display: isOpen ? "none" : "block",  }}  className="menu-title">eCommerce</span>
                  </Link>
                </div>
                <div className="menu-item">
                ...
                <div className="menu-item">
                  ...
                  >
                    ...
                    <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Online Courses</span>
                  </Link>
                </div>
                <div className="menu-item">
                  <Link to ='/marketingcontent'
                    className="menu-link"
                  ...
                  >
                    ...
                    <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Marketing</span>
                  </Link>
                </div>
                <div className="menu-item">
                  <Link to = '/biddingcontent'
                    className="menu-link"
                  ...
                  >
                    ...
                    <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Bidding</span>
                  </Link>
                </div>
...
{ isSh && <div
 className="menu-inner flex-column "

>
 <div className="menu-item">
   <Link to = '/logisticcontent'
     className="menu-link"
   ...
   >
     ...
     <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Logistics</span>
   </Link>
 </div>
 <div className="menu-item">
   <Link to = '/deliverycontent'
     className="menu-link"
   ...
   >
     ...
     <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Delivery</span>
   </Link>
 </div>
 <div className="menu-item">
   <Link to ='/websiteanalytics'
     className="menu-link"
   ...
   >
     ...
     <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Website Analytics</span>
   </Link>
 </div>
 <div className="menu-item">
   <Link to  = '/financeperformance'
     className="menu-link"
   ...
   >
     ...
     <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Finance Performance</span>
   </Link>
 </div>

 <div className="menu-item">
   <Link to = '/socialcontent'
     className="menu-link"
   >
     <span className="menu-bullet">
       <span className="bullet bullet-dot" />
     </span>
     <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Social</span>
   </Link>
 </div>
 ...
 <div className="menu-item">
   ...
   >
     ...
     <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">School</span>
   </Link>
 </div>
 ...
 <div className="menu-item">
   ...
   >
     ...
     <span style={{ display: isOpen ? "none" : "block",  }} className="menu-title">Landing</span>
   </Link>
 </div>
</div>
                ...
                <div className="menu-item">
                  <div className="menu-content">
                    <a
                      className="btn btn-flex btn-color-success fs-base p-0 ms-2 mb-2 rotate"
           ...
           // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5%%%%%%%%%
                      ...
                      // href="#kt_aside_menu_collapse"
                      // data-kt-toggle-text="Show Less coooooolllll"
                  ...
                  {isSh ? <>  <span onClick={fatSh} style={{ display: isOpen ? "none" : "block",  }}>
                  Show Less
                   
                  </span></> : <> <span onClick={fatSh} style={{ display: isOpen ? "none" : "block",  }}>
                  Show 10 More
                    ...
                    <div
                      ...
                      className="menu-item menu-lg-down-accordion me-lg-1"
                    >
                     <div style={{position:'relative',top:'0px', marginLeft: '35px'}} onClick={handleExpandCrafted}>
                        <span>Crafted</span>
                        <span className="menu-arrow d-lg-none" />
                      </div>

 {
   ...
   <div style={{backgroundColor: 'White' , position:'fixed', top: '56px'  ,left: '364px', right:'822px'}}>
...
<div >
                    ...
                    <div
                      ...
                      className="menu-item menu-lg-down-accordion me-lg-1"
                    >
                     <div style={{position:'relative',top:'0px', marginLeft: '35px'}} onClick={handleExpandapp}>
                        <span>Apps</span>
                        <span className="menu-arrow d-lg-none" />
                      </div>
...
<div style={{backgroundColor: 'White' , position:'fixed', top: '56px'  ,left: '428px'}}>
...
<div>
                    ...
                    >
                     ...
                     <div style={{position:'relative',top:'0px', marginLeft: '35px'}} onClick={handleExpandLayouts}>
                        <span>Layouts</span>
                        <span className="menu-arrow d-lg-none" />
                      </div>
                      ...
                      {expandlayouts && 
                      <div style={{backgroundColor: 'White' , position:'fixed', top: '56px'  ,left: '511px'}}>
...
<div >
                    ...
                    >
                      ...
                      <div style={{position:'relative',top:'0px', marginLeft: '35px'}} onClick={handleExpandResources}>
                        <span>Resources</span>
                        <span className="menu-arrow d-lg-none" />
                      </div>
...
<div style={{backgroundColor: 'White' , position:'fixed', top: '56px'  ,left: '589px'}}>
...
<div>
                    ...
                    <div
                      ...
                      className="menu-item menu-lg-down-accordion me-lg-1"
                    >
                      <div style={{position:'relative',top:'0px', marginLeft: '23px'}} onClick={handleExpandMegamap}>
                        <span>Mega Menu</span>
                        <span className="menu-arrow d-lg-none" />
                      </div>
...
<div style={{backgroundColor: 'White' , position:'fixed', top: '56px'  ,left: '688px'}}>
<div >
                        {/*begin:Row*/}
              ...
              <div style = {{ position: 'relative',backgroundColor:"white" ,left: '170px' }}className="d-flex align-items-stretch flex-shrink-0">
                {/*begin::Search*/}
                ...
                >
                  ...
                  <div onClick={handleExpanduser}
                    ...
                    data-kt-menu-placement="bottom-end"
                  >
                    <img src={x} alt="userssssss" />
                  </div>

                  
       {expanduser && 
       
       <div  style={{backgroundColor: 'white', position:'fixed', top: '56px'  ,left: '1103px'}}>
           <div
