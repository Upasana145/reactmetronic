...
import Kk from "./assets/media/logos/logo-1-dark.svg";
...
const SidePanel = ({ isOpen, toggle }) => {
  ...
  //const [pageexpand, pageShow] = useState(false)
  //const pageHandleExpand = () =>
  //{
  //  pageShow(!pageexpand)

  //}

  //const [accountexpand, accountShow] = useState(false)
  //const accountHandleExpand = () =>
  //{
  //  accountShow(!accountexpand)

  //}

  //const [authenticationexpand, authenticationShow] = useState(false)
  //const authenticationHandleExpand = () =>
  //{
  //  authenticationShow(!authenticationexpand)

  //}

  //const [utilitiesexpand, utilitiesShow] = useState(false)
  //const utilitiesHandleExpand = () =>
  //{
  //  utilitiesShow(!utilitiesexpand)

  //}

  //const [widget, widgetShow] = useState(false)
  //const widgetHandleExpand = () =>
  //{
  // widgetShow(!widget)
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55 */}
                  {/* removed <div className="menu-sub menu-sub-accordion menu-active-bg" > */}
                  {sectionsOpen["section1"] && (
                    <>
                      <div className="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div className="menu-item">
                          <Link to="/marketingcontent" className="menu-link">
                            <span className="menu-bullet">
                              <span className="bullet bullet-dot" />
                            </span>
                            <span
                        ...
                        {isShow && (
                          <div className="menu-inner flex-column ">
                            <div className="menu-item">
                              <Link to="/logisticcontent" className="menu-link">
                                <span className="menu-bullet">
                                  <span className="bullet bullet-dot" />
                                </span>
                                <span
                            ...
                            <div className="menu-item">
                              <Link to="/storeanalytics" className="menu-link">
                                <span className="menu-bullet">
                                  <span className="bullet bullet-dot" />
                                </span>
                                <span
                            ...
                            <div className="menu-item">
                              <Link to="/socialcontent" className="menu-link">
                                <span className="menu-bullet">
                                  <span className="bullet bullet-dot" />
                                </span>
                                <span
